...
class _BaseScreen extends State<BaseScreen> {
  ...
  void initState() {
    super.initState();
    screens.add(PendingAssignmentsScreen(course: course));
    screens.add(ListAssignmentsScreen(course: course));
    screens.add(GradesScreen(course: course));
    screens.add(ModulesScreen(course: course));
    screens.add(PageScreen(course: course));
  }
